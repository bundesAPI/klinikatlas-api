...
from deutschland.klinikatlas import rest
from deutschland.klinikatlas.configuration import Configuration
from deutschland.klinikatlas.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.klinikatlas.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.fileadmin_json_german_places_json_get  # this is an instance of the class Endpoint
        api_instance.fileadmin_json_german_places_json_get()  # this invokes api_instance.fileadmin_json_german_places_json_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.fileadmin_json_german_places_json_get.callable or self.callable in this class
