...
class SearchresultsGet200ResponseFiltersFieldsInnerOptionsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SearchresultsGet200ResponseFiltersFieldsInnerOptionsInner - a model defined in OpenAPI
