...
class SearchresultsGet200ResponseSortingsFieldsInnerOptionsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SearchresultsGet200ResponseSortingsFieldsInnerOptionsInner - a model defined in OpenAPI
